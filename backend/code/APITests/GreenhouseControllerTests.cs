...
namespace APITests
{
    ...
    public class GreenhouseControllerTests
    {
        ...
        private readonly Greenhouse _testGreenhouse =
            new()
            {
                Id = 1,
                Name = "TestGreenhouse",
        ...
        private readonly GreenhouseDTO _validDto =
            new() { Name = "TestGreenhouse", GardenerId = 1 };
        ...
        {
            _mockGreenhouseLogic
                .Setup(x => x.GetGreenhouses())
                .ReturnsAsync(new List<Greenhouse>());
        ...
        {
            _mockGreenhouseLogic
                .Setup(x => x.GetGreenhouseById(99))
                .ReturnsAsync((Greenhouse)null!);
        ...
        {
            _mockGreenhouseLogic
                .Setup(x => x.GetGreenhouseByGardenerId(1))
                .ReturnsAsync(_testGreenhouse);
        ...
        {
            _mockGreenhouseLogic
                .Setup(x => x.GetGreenhouseByGardenerId(99))
                .ReturnsAsync((Greenhouse)null!);
            ...
            if (result.Result is NotFoundObjectResult notFoundResult)
            {
                Assert.That(
                    ...
                    Is.EqualTo("Greenhouse with gardenerId 99 does not exist.")
                );
            }
            else
            {
        ...
        public async Task GetGreenhouseByNameAsync_ReturnsOkWithGreenhouse_WhenGreenhouseExists()
        {
            ...
            _mockGreenhouseLogic
                .Setup(x => x.GetGreenhouseByName(greenhouseName))
                .ReturnsAsync(_testGreenhouse);
        ...
        public async Task GetGreenhouseByNameAsync_ReturnsNotFound_WhenGreenhouseDoesNotExist()
        {
            ...
            _mockGreenhouseLogic
                .Setup(x => x.GetGreenhouseByName(nonExistentName))
                .ReturnsAsync((Greenhouse)null!);
            ...
            if (result.Result is NotFoundObjectResult notFoundResult)
            {
                Assert.That(
                    notFoundResult.Value,
                    Is.EqualTo($"Greenhouse with name {nonExistentName} does not exist.")
                );
            }
            else
            {
        ...
        public async Task AddGreenhouseAsync_ReturnsOk_WhenGreenhouseIsAdded()
        {
            _mockGreenhouseLogic
                ...
                .ReturnsAsync(new List<Greenhouse>());
            _mockGreenhouseLogic
                .Setup(x => x.AddGreenhouse(_validDto))
                .ReturnsAsync(_testGreenhouse);
        ...
        {
            var existingGreenhouses = new List<Greenhouse>
            {
                new()
                {
                    Id = 1,
                    Name = "ExistingGreenhouse",
                    GardenerId = 1
                }
            };
            ...
            if (result.Result is BadRequestObjectResult badRequestResult)
            {
                ...
                Assert.That(
                    ...
                    Is.EqualTo("You can only create one greenhouse.")
                );
            }
            else
            {
        ...
        public async Task DeleteGreenhouseAsync_ReturnsBadRequest_WhenGreenhouseHasPlants()
        {
            ...
            _mockGreenhouseLogic.Setup(x => x.GetGreenhouseById(1)).ReturnsAsync(_testGreenhouse);
            _mockGreenhouseLogic
                .Setup(x => x.DeleteGreenhouse(1))
                .ThrowsAsync(new Exception("Error", new Exception("Plant_greenhouseid_fkey")));
            ...
            if (result is BadRequestObjectResult badRequestResult)
            {
                ...
                Assert.That(
                    badRequestResult.Value,
                    Is.EqualTo("Cannot delete Greenhouse because it is associated with a Plant.")
                );
            }
            else
            {
        ...
        public async Task DeleteGreenhouseAsync_ReturnsBadRequest_WhenGreenhouseHasSensors()
        {
            ...
            _mockGreenhouseLogic
                .Setup(x => x.DeleteGreenhouse(1))
                .ThrowsAsync(new Exception("Error", new Exception("Sensor_greenhouseid_fkey")));
            ...
            if (result is BadRequestObjectResult badRequestResult)
            {
                ...
                Assert.That(
                    badRequestResult.Value,
                    Is.EqualTo("Cannot delete Greenhouse because it has associated Sensors.")
                );
            }
            else
            {
